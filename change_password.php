...
$patient=mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM `patient` WHERE `patient_id`='$_SESSION[patient_id]'"));
if(isset($_POST) && $_POST['Submit']=="Update")
{
	
	$update=mysqli_query($connect,"UPDATE `patient` SET `password`='$new_password' WHERE `patient_id`='$patient_id'");
